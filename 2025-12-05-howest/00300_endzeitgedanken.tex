\interlude{The end is neigh (quantum attacks)}

\begin{frame}[T]{Doom sayers: \say{Please Like and Subscribe}}
...
\begin{frame}[T]{Quantum computing – As soon as we have fusion power}
...
\begin{frame}[T]{When networked world stops turning}
  \begin{columns}[T,fullwidth]
    ...
    \begin{column}{.45\linewidth}
      ...
      \begin{itemize}
        ...
        \item We work on the internet
        \setlength{\itemindent}{-2ex}
        \item We manage critical infrastructure 
        \setlength{\itemindent}{-3.8ex}
        \item Our supply chains depend on it
      \end{itemize}
    \end{column}
    \hfill
  \end{columns}
...
\begin{frame}[T]{Hoarding hamster attacker}
  ...
  \begin{columns}[T,fullwidth]
    ...
    \begin{column}{.5\textwidth}
      \vspace{4em}
      \begin{itemize}
        \item Angreifer hoard encrypted communication
        \vspace{.8em}
        \item This enables attacking past communication
        \vspace{.8em}
