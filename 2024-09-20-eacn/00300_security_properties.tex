...
\begin{frame}{Passive attacker are eavesdropping}
  \includegraphics[height=\defaultframetextheight]{graphics-repo/comic/rosenpass-comic_03-interception1.jpeg}
\end{frame}

\begin{frame}{Active attackers are intercepting}
  \includegraphics[height=\defaultframetextheight]{graphics-repo/comic/rosenpass-comic_03-interception2.jpeg}
\end{frame}
...
\begin{frame}{Forward secrecy}
  \centering
  \only<1>{
    \includegraphics[width=.32\textwidth]{graphics-repo/comic/rosenpass-comic_09-forward-secrecy1.jpeg}
    \includegraphics[width=.32\textwidth]{graphics-repo/comic/rosenpass-comic_09-forward-secrecy2.jpeg}
    \includegraphics[width=.32\textwidth]{graphics-repo/comic/rosenpass-comic_09-forward-secrecy3.jpeg}
    \large
  ...
  \only<2>{
    \includegraphics[width=.32\textwidth]{graphics-repo/comic/rosenpass-comic_09-forward-secrecy6.jpeg}
    \includegraphics[width=.32\textwidth]{graphics-repo/comic/rosenpass-comic_09-forward-secrecy8.jpeg}
    \large
    \\ Which is no help against active attackers -- interception -- though.
  }
  \only<3>{
    \includegraphics[width=.32\textwidth]{graphics-repo/comic/rosenpass-comic_09-forward-secrecy4.jpeg}
    \includegraphics[width=.32\textwidth]{graphics-repo/comic/rosenpass-comic_09-forward-secrecy5.jpeg}
    \includegraphics[width=.32\textwidth]{graphics-repo/comic/rosenpass-comic_09-forward-secrecy8.jpeg}
    \large
...
\begin{frame}{Everlasting secrecy (QKD)}
  \centering
  \only<1>{
    \includegraphics[width=.32\textwidth]{graphics-repo/comic/rosenpass-comic_10-everlasting-secrecy1.jpeg}
    \includegraphics[width=.32\textwidth]{graphics-repo/comic/rosenpass-comic_10-everlasting-secrecy2.jpeg}
    \includegraphics[width=.32\textwidth]{graphics-repo/comic/rosenpass-comic_10-everlasting-secrecy3.jpeg}
    \large
