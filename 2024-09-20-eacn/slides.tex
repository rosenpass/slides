...
\usepackage{bbding}
% Add proper “actual text“ for checkmark and cross
\usepackage{accsupp}
\let\bbdingCheckmark\Checkmark
\let\bbdingXSolidBrush\XSolidBrush
\renewcommand*{\Checkmark}{%
	\BeginAccSupp{method=hex,unicode,ActualText=2713}%
	\bbdingCheckmark%
	\EndAccSupp{}%
}
\renewcommand*{\XSolidBrush}{%
	\BeginAccSupp{method=hex,unicode,ActualText=2717}%
	\bbdingXSolidBrush%
	\EndAccSupp{}%
}
...
%		}
		\includegraphics[width=\paperwidth,height=\paperheight]{
			artsy-slide-backgrounds-smaller-hd/artsy-mild-bg-\int_use:N \g__ptxcd_interlude_page_int}
			%rosenpass-interlude-generic-\int_use:N \g__ptxcd_interlude_page_int}
	} {
		\includegraphics[width=\paperwidth,height=\paperheight]{
			artsy-slide-backgrounds-smaller-hd/artsy-mild-bg-1\l__ptxcd_rosenpass_interlude_tl}
			%rosenpass-interlude-\l__ptxcd_rosenpass_interlude_tl}
	}
}
