...
\setbeamertemplate{background canvas}{\includegraphics[width=\paperwidth]{comic/kryptoparty-wide}}
...
\begin{frame}{Open-Source \& Open-Science are mandatory}
  \begin{columns}[onlytextwidth,c]
      \begin{column}<only@+|handout:+>{\defaultframetextheight}
        \includegraphics[width=.5\linewidth]{comic/rosenpass-comic_01-obscurity1.jpg}%
        \includegraphics[width=.5\linewidth]{comic/rosenpass-comic_01-obscurity2.jpg}

        \includegraphics[width=.5\linewidth]{comic/rosenpass-comic_01-obscurity3.jpg}%
        \includegraphics[width=.5\linewidth]{comic/rosenpass-comic_01-obscurity4.jpg}
      \end{column}
	...
	\hfill
      \begin{column}<only@.|handout:.>{\defaultframetextheight}
        \includegraphics[width=.5\linewidth]{comic/rosenpass-comic_02-disclosure1.jpg}%
        \includegraphics[width=.5\linewidth]{comic/rosenpass-comic_02-disclosure2.jpg}
      \end{column}
  \end{columns}
\end{frame}
