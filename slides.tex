...
\framesubtitle{Mit NIKEs\footnote{\say{Non-Interactive Key Exchange} -- Nichtinteraktiver Schlüsselaustausch}}
\begin{tikzpicture}[
rosenpass-diagram,
...
%\end{document}
%
\begin{frame}{Einfachst-möglicher Schlüsseltausch mit KEMs\footnote{\say{Key-Encapsulation Method} -- Schlüsseltransportmethode}}
\begin{tikzpicture}[
rosenpass-diagram,
  % define multiple syles for consistency
  boxed-node/.style = {draw, rectangle, fill=white, text width = 5em, align = center, minimum height = 1.75em, rounded corners},
...
\begin{frame}{Post-Quantum WireGuard: 3 Schlüsseltransporte}
