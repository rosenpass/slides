...
\begin{column}{.30\textwidth}
  ...
  \say{Munch now decrypt later}
  \footnote{\say{Jetzt speichern später entschlüsseln}. Warnung: Geheimdienste sind nicht so cute wie dieser Hamster.}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Chiffren}
  \begin{itemize}
    \item Authentifikation \& Geheimheit: \textbb{Classic McEliece} (erfunden 1979, Codebasiert)
    \item Forward Secrecy: \textbb{Kyber} (NIST-Standardisiert, Gitter)
