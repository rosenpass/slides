...
\begin{frame}[T]{}
  ...
  \only<1>{
    \shiftbox{-0.12\textwidth}{
      \fbox{\includegraphics[width=1.20\textwidth,page=10,trim=95 340 90 480]{slide-graphics-qrn.pdf}}
    }
    \\[1.5em] The internet is an architecture for \textbf{transport-agnostic} networking.
  }
  \only<2>{
    \shiftbox{-0.12\textwidth}{
      \fbox{\includegraphics[width=1.20\textwidth,page=11,trim=95 340 90 480]{slide-graphics-qrn.pdf}}
    }
