...
\title[Developing a high-security cryptographic protocol]{The Rosenpass protocol and attacks we found against WireGuard while developing it}
\subtitle{Computer-Aided Verification of a KEM-based Authenticated Key Exchange Protocol}
