...
\begin{frame}{Combining two KEMs with the GHP Combiner}
  \begin{columns}[c]
    ...
    \begin{column}{.55\linewidth}
     \includegraphics[width=\linewidth,page=1,clip=true,trim={29 43  29 58}]{rosenpass-encapsulation-combiner.pdf}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Turning a NIKE into a KEM}
  \begin{columns}[c]
    \begin{column}{.55\linewidth}
    \includegraphics[width=\linewidth,page=2,clip=true,trim={29 43  29 58}]{rosenpass-encapsulation-combiner.pdf}
    \end{column}%
...
\begin{frame}{X-Wing \citeXwing}
  \begin{columns}[c]
    ...
    \end{column}
    \begin{column}{.55\linewidth}
      \includegraphics[width=\linewidth,page=3,clip=true,trim={29 43  29 58}]{rosenpass-encapsulation-combiner.pdf}
    \end{column}
...
\begin{frame}{Rosenpass \& WireGuard Hybridization}
  \begin{columns}[c]
    \begin{column}{.5\linewidth}
      \includegraphics[width=\linewidth, clip=true,trim=42 41 42 42]{rosenpass-wireguard-hybrid-security.pdf}
    \end{column}
    \begin{column}{.45\linewidth}
      \small
      \begin{itemize}
