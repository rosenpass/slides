...
\begin{frame}{Combining two KEMs with the GHP-Combiner}
  \centering
  \includegraphics[height=\defaultframetextheight]{graphics/ghp-combiner.pdf}
\end{frame}

\begin{frame}{Turning a NIKE into a KEM}
  \centering
    \includegraphics[height=\defaultframetextheight]{graphics/dhkem.pdf}
\end{frame}

\begin{frame}{X-Wing}
  \centering
  \includegraphics[height=\defaultframetextheight]{graphics/xwing.pdf}
\end{frame}
