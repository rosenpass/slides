\interlude{Kryptoagilität \\ \Large \rule{.7\linewidth}{\arrayrulewidth}\\[1.2em]  Leitmotiv}


\SetNextBackground{\includegraphics[width=\paperwidth,page=16]{hpke-slide-designs}}
\begin{frame}[light]{}
%
%  \begin{itemize}
