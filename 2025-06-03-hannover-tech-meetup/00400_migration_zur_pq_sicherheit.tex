...
Bild: Timeline
%TODO(marei): Können wir den NIST-Wettbewerb als ein Zeitraum statt zeitpunkte absichern?
%
%       2016                  2024
%       |                     | 
% … ---------------------------------------> ...
...
%       ======================+============> ...
%       NIST-Wettbewerb        \
%                               \ Erster Standard verabschiedet

\begin{itemize}
  \item 1978: Classic McEliece: 1. PQ-Sichere Chiffre
  \item 1994: Kritische Quantenangriffe gefunden
  \item 2016: Wettbewerb angekündigt: PQ-Sichere Standardchiffren % – https://csrc.nist.gov/Projects/post-quantum-cryptography/news
  \item 2019: Experiment: PQ-Sicherheit auf öffentlichen Websiten % – https://blog.cloudflare.com/towards-post-quantum-cryptography-in-tls/
  \item 2022: OpenSSH abgesichert % – https://www.openssh.com/txt/release-9.0
  ...
  \item 2024: NIST-Wettbewerb: Erster Standard verabschiedet % – https://csrc.nist.gov/News/2024/postquantum-cryptography-fips-approved
