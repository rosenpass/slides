...
\begin{frame}[T]{Sichere Kommunikationsräume Schaffen}
  \begin{columns}[t,fullwidth]
    ...
    \begin{column}{.35\linewidth}
      \centering
      \includegraphics[width=.305\pagewidth]{graphics-repo/comic/rosenpass-comic-diary.png}   
      \\ Schutz von Privatem
    \end{column}
    \begin{column}{.55\linewidth}
      \centering
      \includegraphics[width=.30\pagewidth]{graphics-repo/comic/rosenpass-comic-safe.png}   
...
\begin{frame}[T]{Digitale Räume, so sicher wie die analogen}
  \includegraphics[height=\defaultframetextheight]{graphics-repo/comic/rosenpass-comic-rgm-1.png}
\end{frame}
...
\begin{frame}[T]{Datenströme wie Kauderwelsch}
  \begin{columns}[T,fullwidth]
    \hfill
    \begin{column}{.55\linewidth}
      \includegraphics[height=\defaultframetextheight,trim=65 0 65 0,clip]{graphics-repo/comic/rosenpass-comic-rgm-2.png}
    \end{column}
