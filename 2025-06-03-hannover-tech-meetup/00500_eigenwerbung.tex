...
\begin{frame}[T]{PQ-Sicherheit ohne Infrastrukturaustausch}
    \centering
  \only<1>{
    \includegraphics[height=.86\defaultframetextheight]{graphics-repo/comic/rosenpass-comic-rgm-3.png}
  }
  \only<2>{
    \includegraphics[height=.86\defaultframetextheight]{graphics-repo/comic/rosenpass-comic-rgm-4.png}
