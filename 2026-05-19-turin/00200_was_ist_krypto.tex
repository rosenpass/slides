...
\interlude{What is infrastructure?}

\begin{frame}[T]{}
  \centering
  \includegraphics[height=1.15\defaultframetextheight]{graphics/Sathorn_Unique_Tower.jpg}
...
\begin{frame}[T]{}
  \centering
  \includegraphics[height=1.15\defaultframetextheight]{graphics/Howrah_Bridge.jpg}
...
\begin{frame}{Collaborating with Quantum Optics Jena}
  \begin{columns}[fullwidth,c]
    ...
    \begin{column}{\dimexpr.5\linewidth-.25\LeftSlideIndent}
      ...
      \\[1.2em] \shiftbox{-6em}{\includegraphics[height=4.5em,trim=0 0 240 0]{graphics/qoj.pdf}}
    \end{column}%
  \end{columns}
\end{frame}
