...
\column{.6\textwidth}
\begin{itemize}
  \item Grovers Algorithmus \textbb{schwächt} symmetrische Kryptografie
  \begin{itemize}
    \item AES, SHA-2, SHA-3, Chacha20
    \item Lösung: größere Keys
  \end{itemize}
  \item Shors Algorithmus \textbb{bricht} asymmetrische Kryptografie
  \begin{itemize}
...
\ImgSource{%
\makebox[\linewidth][c]{
  \includegraphics[height=.5\textheight]{graphics/qc and crypto.png}}}{Quantencomputer überschatten Kryptografieverfahren.}
